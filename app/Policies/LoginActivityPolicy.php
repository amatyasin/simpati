...
class LoginActivityPolicy
{
    ...
    public function update(User $user, LoginActivity $activity): bool { return false; }
    public function delete(User $user, LoginActivity $activity): bool { return false; }
    public function restore(User $user, LoginActivity $activity): bool { return false; }
    public function forceDelete(User $user, LoginActivity $activity): bool { return false; }
}
